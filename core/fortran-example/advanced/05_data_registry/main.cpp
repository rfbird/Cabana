...
// Make a single static data_registry object to interact with
static data_registry<std::string, void> ds;
...
int main( int argc, char* argv[] )
{
  ...
  */
  ...
  // Try delete the thing from the data store
  delete static_cast<AosoaTYPE*>(ds.get("aosoa"));
